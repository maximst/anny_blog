...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'PollVoice'
        db.create_table(u'poll_pollvoice', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
            ('pollchoice', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['poll.PollChoice'])),
            ('created_at', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
        ))
        db.send_create_signal(u'poll', ['PollVoice'])
    ...
    def backwards(self, orm):
        ...
        # Deleting model 'PollVoice'
        db.delete_table(u'poll_pollvoice')
