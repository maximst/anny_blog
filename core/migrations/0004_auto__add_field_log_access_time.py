...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Log.access_time'
        db.add_column(u'core_log', 'access_time',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, default=datetime.datetime(2013, 5, 4, 0, 0), blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Log.access_time'
        db.delete_column(u'core_log', 'access_time')
