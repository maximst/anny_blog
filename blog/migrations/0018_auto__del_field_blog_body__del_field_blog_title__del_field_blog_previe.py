...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        db.add_column(u'blog_blog', 'preview',
    ...
    models = {
        ...
        u'blog.blog': {
            'Meta': {'unique_together': '()', 'object_name': 'Blog', 'index_together': '()'},
            'create_time': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'deleted': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'edit_time': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'blank': 'True'}),
            'front_page': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'image_rows': ('django.db.models.fields.PositiveIntegerField', [], {'default': '1', 'max_length': '2'}),
        ...
        u'blog.blogimage': {
            ...
            'ext_url': ('django.db.models.fields.URLField', [], {'max_length': '2048', 'null': 'True', 'blank': 'True'}),
            'front_page': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        u'blog.blogtranslation': {
            'Meta': {'unique_together': "(('language_code', 'master'),)", 'object_name': 'BlogTranslation', 'db_table': "u'blog_blog_translation'", 'index_together': '()'},
            'body': ('django.db.models.fields.TextField', [], {'default': "''"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'language_code': ('django.db.models.fields.CharField', [], {'max_length': '15', 'db_index': 'True'}),
            'master': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'translations'", 'null': 'True', 'to': u"orm['blog.Blog']"}),
        ...
        u'blog.mediafile': {
            'Meta': {'object_name': 'MediaFile', '_ormbases': [u'filer.File']},
        ...
        u'poll.poll': {
            ...
            'created_at': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'question': ('django.db.models.fields.TextField', [], {'unique': 'True'}),
