...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'BlogImage.front_page'
        db.add_column(u'blog_blogimage', 'front_page',
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'BlogImage.front_page'
        db.delete_column(u'blog_blogimage', 'front_page')
