...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Blog.image_rows'
        db.add_column(u'blog_blog', 'image_rows',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=1, max_length=2),
                      keep_default=False)

        # Adding field 'BlogImage.on_top'
        db.add_column(u'blog_blogimage', 'on_top',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Blog.image_rows'
        db.delete_column(u'blog_blog', 'image_rows')

        # Deleting field 'BlogImage.on_top'
        db.delete_column(u'blog_blogimage', 'on_top')
    ...
    models = {
        ...
        u'blog.blogimage': {
            ...
            'on_top': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
