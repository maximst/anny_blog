...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'BlogImage.image'
        db.alter_column(u'blog_blogimage', 'image', self.gf('django.db.models.fields.files.ImageField')(max_length=1024))

    def backwards(self, orm):

        # Changing field 'BlogImage.image'
        db.alter_column(u'blog_blogimage', 'image', self.gf('django.db.models.fields.files.ImageField')(max_length=100))
